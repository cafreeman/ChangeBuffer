...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ChangeBuffer_1 = __webpack_require__(1);
	exports.ChangeBuffer = ChangeBuffer_1.ChangeBuffer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChangeBuffer = (function () {
	    function ChangeBuffer(object) {
	        this.object = object;
	        this.buffer = fp_1.cloneDeep(object);
	    }
	    ChangeBuffer.prototype.isClean = function () {
	        return fp_1.isEqual(this.object, this.buffer);
	    };
	    ChangeBuffer.prototype.isDirty = function () {
	        return fp_1.negate(fp_1.isEqual)(this.object, this.buffer);
	    };
	    ChangeBuffer.prototype.rollback = function () {
	        this.buffer = fp_1.cloneDeep(this.object);
	        return this.buffer;
	    };
	    ...
	    ChangeBuffer.prototype.apply = function () {
	        return fp_1.assign(this.object, this.buffer);
	    };
	    return ChangeBuffer;
	}());
